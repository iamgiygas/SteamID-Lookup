...
Javascript is disabled on your browser! Expect everything to be broken. Please enable Javacript for us, the site only uses it for good purposes! Not all of us are evil! O̠͓̼̤ͅh͈͖͇ͅ ̣̦͟g̣̥̀od͏͕͈͚͈̯̖,́ ͟i̱̤͕t͓̭̣̮͇̟̘͞'҉̠̜͙̼s̷̝ ̫͖̳͎͢s͕̣̹͓̱̲̀ṭ̼͍̀a͇r͙̮͉͈͈̠͡t̳̮̼̻̹i͉̼̣̥̬͞n͍̘̝͉̜̦̣͢g͉͖̻̮̺ͅ.͍ͅ.̭̤.̧̟̞͙͉͙͖̻
</div>
</noscript>	

<section class="hero is-dark is-dark is-fullheight is-bold">
...
<a class="navbar-item">
			Welcome, <?= ($steamprofile['personaname']) ?>!
</a>
...
<div class="hero-body">
	...
	<h1 class="title">
		SteamID Search, no bullshit.
	</h1>
	<form>
	<div class="field has-addons has-addons-centered">
		<p class="control">
		<input class="input" placeholder="Search..." id="q" name="q" type="text">
		</p>
		<p class="control">
		<a id="searchButton" class="button is-link"> 
			Search
		</a>	
		</p>
	</div>
...
<section class="hero">
  <div class="hero-body">
    <div class="container">
	<?php if($steamid!="") echo 'Result for '.htmlentities($steamid).''; ?>
...
<script src="<PATH TO LIBRARY>/js/no.min.js"></script>
</body>
</html>